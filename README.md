...
2. Copy `obsidian-kanban/` and `obsidian-samplelog-main/` into your vault's `.obsidian/plugins/` folder
3. Enable both plugins in Obsidian Settings > Community Plugins

## Plugins

### obsidian-kanban
Kanban board plugin with Calendar view support.
...
```bash
git pull
cp -r obsidian-kanban/*            <YOUR_VAULT>/.obsidian/plugins/obsidian-kanban/
